...
from DataModules.CIFAR10DataModule import CIFAR10DataModule
...
def main_func(args):
    ...
    data_module = CIFAR10DataModule(**dict_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--logging_dir",
        type = str,
        default = "./logs/tb_logs",
        help = "Address of the logs directory. [default: ./logs/tb_logs]"
    )
