...
parser.add_argument('--checkpoint-path',metavar='S',help='add this flag to determine the path to a checkpoint.')
...
if __name__ == '__main__':
    ...
    new_model = customVAE.load_from_checkpoint(checkpoint_path=args.checkpoint_path)
